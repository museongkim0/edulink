    ...
    <section class="w-full max-w-7xl mx-auto">
      <header class="mb-6 flex items-center justify-between">
        <div class="flex items-center">
          ...
          <h1 class="text-4xl font-semibold text-gray-800 dark:text-white">과제</h1>
        </div>
      </header>
...
onMounted(() => {
  boardStore.getBoardList(4, currentPage.value - 1, pageSize);
});

watch(currentPage, (newVal) => {
  boardStore.getBoardList(4, newVal, pageSize);
});
</script>
